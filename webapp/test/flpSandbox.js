		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP INWI Cash Management",
									"targetURL": "#cashmanagementinwi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cashmanagementinwi-display": {
								"semanticObject": "cashmanagementinwi",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cashmanagementinwi",
									"url": sap.ui.require.toUrl("cashmanagementinwi")
								}
							}
						}
					}
